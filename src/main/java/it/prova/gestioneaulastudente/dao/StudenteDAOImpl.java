...
public class StudenteDAOImpl implements StudenteDAO {
	...
	public List<Studente> findByAula(Aula aulaInstance) {
		TypedQuery<Studente> query = entityManager.createQuery("from Studente s join fetch s.aula a where a.id = :aula",
				Studente.class);
		return query.setParameter("aula", aulaInstance.getId()).getResultList();
